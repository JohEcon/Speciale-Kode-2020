...
class Household(Agent):
    ...
    def __init__(self, parent=None, wealth= 0, pdeath = 0, income = 0, age = Settings.starting_age, dead = 0, died_last_period = 0):
        ...
        if self._dead == 0:
            ...
            #check if household wants to move, if so, initiate moving procedure
                if random.uniform(0,1) < 0.1:
                    ...
                    print(Bank.max_loan_household(Danske_Bank, self._age, self._income, Settings.loan_lenght,
